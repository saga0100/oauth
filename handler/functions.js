...
async function paginacion(client, interaction, texto, titulo = "Page", footer= "Styx", elementos_por_pagina = 15) {
    ...
    let boton_atras = new discord.MessageButton().setStyle('SUCCESS').setCustomId('Atrás').setEmoji('929001012176507040').setLabel('Précédant')
    let boton_inicio = new discord.MessageButton().setStyle('DANGER').setCustomId('Inicio').setEmoji('🏠').setLabel('Accueil')
    let boton_avanzar = new discord.MessageButton().setStyle('SUCCESS').setCustomId('Avanzar').setEmoji('929001012461707335').setLabel('Suivant')
